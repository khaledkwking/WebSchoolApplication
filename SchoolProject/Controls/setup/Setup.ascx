<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Setup.ascx.cs" Inherits="WebSchool.Controls.Setup.Setup" %>
...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-subheader__main">
        ...
        <div class="kt-subheader__breadcrumbs">
            ...
            <%--  <asp:Literal runat="server" Text="<%$ Resources:DefaultResource, AccountQids%>" />--%><%-- <%= Request.QueryString["TypeId"].ToString() == GLibrary.strarrQidTypes[0, 0].ToString() ? Resources.DefaultResource.AccountQids :""  %>
...
<%--<div class="kt-portlet kt-portlet--mobile">--%>
 ...
 <div id="ErrorDiv" class="col-10" runat="server"></div>
     </div>
 <br />
...
<%--<ul class="nav nav-tabs">--%>
    ...
    <%--    <a data-bs-toggle="tab" href="#menu1"><% =Resources.DefaultResource.CompanyData%></a>--%>
     <a class="nav-link" id="menu1-tab"  data-bs-toggle="tab" href="#menu1" role="tab" aria-controls="profile"> 

         <% =Resources.DefaultResource.CompanyData%></a>
        </li>
     <li class="nav-item" id ="StockTab">
<%--    <li >--%>
         <a class="nav-link" id="home-tab"  data-bs-toggle="tab" href="#home" role="tab" aria-controls="profile"> 
                                ...
                                <div class="col-4">
                                   <asp:TextBox ID="CompanyArNameTextBox" runat="server" AutoComplete="Off"  CssClass="form-control"  />
                                     <asp:RequiredFieldValidator ID="CompanyArNameRequiredFieldValidator" runat="server" ErrorMessage="<%$ Resources:DefaultResource, RequiredField%>" Display="Dynamic"
                                       ControlToValidate="CompanyArNameTextBox" ValidationGroup="DML" CssClass="label label-warning" SetFocusOnError="true">
                                ...
                                <div class="col-4">
                                   <asp:TextBox ID="CompanyArAddressTextBox" runat="server" AutoComplete="Off"  CssClass="form-control"  />
                                     <asp:RequiredFieldValidator ID="CompanyArAddressRequiredFieldValidator" runat="server" ErrorMessage="<%$ Resources:DefaultResource, RequiredField%>" Display="Dynamic"
                                       ControlToValidate="CompanyArAddressTextBox" ValidationGroup="DML" CssClass="label label-warning" SetFocusOnError="true">
                               </asp:RequiredFieldValidator>
                            ...
                            <div class="col-4">
                               ...
                               <asp:TextBox ID="CompanyEngAddressTextBox" runat="server" AutoComplete="Off"  CssClass="form-control"  />
                                     <asp:RequiredFieldValidator ID="CompanyEngAddressRequiredFieldValidator" runat="server" ErrorMessage="<%$ Resources:DefaultResource, RequiredField%>" Display="Dynamic"
                                       ControlToValidate="CompanyEngAddressTextBox" ValidationGroup="DML" CssClass="label label-warning" SetFocusOnError="true">
                               </asp:RequiredFieldValidator>
                                ...
                                <div class="col-4">
                                   <asp:TextBox ID="CompanyTelTextBox" runat="server" AutoComplete="Off"  CssClass="form-control"  />
                                     <asp:RequiredFieldValidator ID="CompanyTelRequiredFieldValidator" runat="server" ErrorMessage="<%$ Resources:DefaultResource, RequiredField%>" Display="Dynamic"
                                       ControlToValidate="CompanyTelTextBox" ValidationGroup="DML" CssClass="label label-warning" SetFocusOnError="true">
                               </asp:RequiredFieldValidator>
                        ...
                        <label class="col-2 col-form-label">
                            ...
                            <div class="col-4">
                               ...
                               <asp:TextBox ID="CompanyArActivityTextBox" runat="server" AutoComplete="Off"  CssClass="form-control"  />
                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="<%$ Resources:DefaultResource, RequiredField%>" Display="Dynamic"
                                       ControlToValidate="CompanyArActivityTextBox" ValidationGroup="DML" CssClass="label label-warning" SetFocusOnError="true">
                               </asp:RequiredFieldValidator>
                            ...
                            <div class="col-10">
                               ...
                               <asp:TextBox ID="CompanyNotesTextBox" runat="server" AutoComplete="Off"  CssClass="form-control"  TextMode ="MultiLine" Height="60px" />
                                     <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="<%$ Resources:DefaultResource, RequiredField%>" Display="Dynamic"
                                       ControlToValidate="CompanyArActivityTextBox" ValidationGroup="DML" CssClass="label label-warning" SetFocusOnError="true">
                               </asp:RequiredFieldValidator>
       ...
       <%-- <div id="home" class="tab-pane fade">--%>
         ...
         <div class="form-group row">
                ...
                <div class="col-4">
                    ...
                    <asp:DropDownList ID="SalesAccountDropDownList" runat="server" CssClass="select-chosen"  data-live-search="true"  
            ...
            <label class="col-2 col-form-label">
                ...
                <div class="col-4">
                    ...
                    <asp:DropDownList ID="SalesCashAccountDropDownList" runat="server" CssClass="select-chosen"  data-live-search="true" 
                        AppendDataBoundItems="True" DataTextField="accountname" DataValueField="accountid" DataSourceID="AccountDS">
                            <asp:ListItem Text="<%$ Resources:DefaultResource, SelectItemPlease%>" Value="0" />
                    </asp:DropDownList>
        ...
        <div class="form-group row">
                ...
                <div class="col-4">
                    ...
                    <asp:DropDownList ID="SalesDebitAccountDropDownList" runat="server" CssClass="select-chosen"  data-live-search="true" 
                        AppendDataBoundItems="True" DataTextField="accountname" DataValueField="accountid" DataSourceID="AccountDS">
                            <asp:ListItem Text="<%$ Resources:DefaultResource, SelectItemPlease%>" Value="0" />
                    </asp:DropDownList>
            ...
            <label class="col-2 col-form-label">
                ...
                <div class="col-4">
                    ...
                    <asp:DropDownList ID="SalesReturnCashAccountDropDownList" runat="server" CssClass="select-chosen"  data-live-search="true" 
                        AppendDataBoundItems="True" DataTextField="accountname" DataValueField="accountid" DataSourceID="AccountDS">
                            <asp:ListItem Text="<%$ Resources:DefaultResource, SelectItemPlease%>" Value="0" />
                    </asp:DropDownList>
        ...
        <div class="form-group row">
          <label for="qididlabel" class="col-2 col-form-label">
                ...
                <div class="col-4">
                    ...
                    <asp:DropDownList ID="SalesReturnDebitAccountDropDownList" runat="server" CssClass="select-chosen"  data-live-search="true" 
                        AppendDataBoundItems="True" DataTextField="accountname" DataValueField="accountid" DataSourceID="AccountDS">
                            <asp:ListItem Text="<%$ Resources:DefaultResource, SelectItemPlease%>" Value="0" />
                    </asp:DropDownList>
            ...
            <label class="col-2 col-form-label">
                ...
                <div class="col-4">
                    ...
                    <asp:DropDownList ID="PurchaseAccountDropDownList" runat="server" CssClass="select-chosen"  data-live-search="true" 
                        AppendDataBoundItems="True" DataTextField="accountname" DataValueField="accountid" DataSourceID="AccountDS">
                            <asp:ListItem Text="<%$ Resources:DefaultResource, SelectItemPlease%>" Value="0" />
                    </asp:DropDownList>
          ...
          <div class="form-group row">
                ...
                <div class="col-4">
                    ...
                    <asp:DropDownList ID="PurchaseCashAccountDropDownList" runat="server" CssClass="select-chosen"  data-live-search="true" 
                        AppendDataBoundItems="True" DataTextField="accountname" DataValueField="accountid" DataSourceID="AccountDS">
                            <asp:ListItem Text="<%$ Resources:DefaultResource, SelectItemPlease%>" Value="0" />
                    </asp:DropDownList>
            ...
            <label class="col-2 col-form-label">
                ...
                <div class="col-4">
                    ...
                    <asp:DropDownList ID="PurchaseDebitAccountDropDownList" runat="server" CssClass="select-chosen"  data-live-search="true" 
                        AppendDataBoundItems="True" DataTextField="accountname" DataValueField="accountid" DataSourceID="AccountDS">
                            <asp:ListItem Text="<%$ Resources:DefaultResource, SelectItemPlease%>" Value="0" />
                    </asp:DropDownList>
         ...
         <div class="form-group row">
                ...
                <div class="col-4">
                    ...
                    <asp:DropDownList ID="PurchaseReturnCashAccountDropDownList" runat="server" CssClass="select-chosen"  data-live-search="true" 
                        AppendDataBoundItems="True" DataTextField="accountname" DataValueField="accountid" DataSourceID="AccountDS">
                            <asp:ListItem Text="<%$ Resources:DefaultResource, SelectItemPlease%>" Value="0" />
                    </asp:DropDownList>
            ...
            <label class="col-2 col-form-label">
                ...
                <div class="col-4">
                    ...
                    <asp:DropDownList ID="PurchaseReturnDebitAccountDropDownList" runat="server" CssClass="select-chosen"  data-live-search="true" 
                        AppendDataBoundItems="True" DataTextField="accountname" DataValueField="accountid" DataSourceID="AccountDS">
                            <asp:ListItem Text="<%$ Resources:DefaultResource, SelectItemPlease%>" Value="0" />
                    </asp:DropDownList>
         ...
         <div class="form-group row">
                ...
                <div class="col-4">
                    ...
                    <asp:DropDownList ID="CashBoxAccountDropDownList" runat="server" CssClass="select-chosen"  data-live-search="true" 
                        AppendDataBoundItems="True" DataTextField="accountname" DataValueField="accountid" DataSourceID="AccountDS">
                            <asp:ListItem Text="<%$ Resources:DefaultResource, SelectItemPlease%>" Value="0" />
                    </asp:DropDownList>
            ...
            <label class="col-2 col-form-label">
                ...
                <div class="col-4">
                    ...
                    <asp:DropDownList ID="BanksAccountDropDownList" runat="server" CssClass="select-chosen"  data-live-search="true" 
                        AppendDataBoundItems="True" DataTextField="accountname" DataValueField="accountid" DataSourceID="AccountDS">
                            <asp:ListItem Text="<%$ Resources:DefaultResource, SelectItemPlease%>" Value="0" />
                    </asp:DropDownList>
         ...
         <div class="form-group row">
                ...
                <div class="col-4">
                    ...
                    <asp:DropDownList ID="CustomersDropDownList" runat="server" CssClass="select-chosen"  data-live-search="true" 
                        AppendDataBoundItems="True" DataTextField="accountname" DataValueField="accountid" DataSourceID="AccountDS">
                            <asp:ListItem Text="<%$ Resources:DefaultResource, SelectItemPlease%>" Value="0" />
                    </asp:DropDownList>
            ...
            <label class="col-2 col-form-label">
                ...
                <div class="col-4">
                    ...
                    <asp:DropDownList ID="suppliersDropDownList" runat="server" CssClass="select-chosen"  data-live-search="true" 
                        AppendDataBoundItems="True" DataTextField="accountname" DataValueField="accountid" DataSourceID="AccountDS">
                            <asp:ListItem Text="<%$ Resources:DefaultResource, SelectItemPlease%>" Value="0" />
                    </asp:DropDownList>
           ...
           <div class="form-group row">
                ...
                <div class="col-4">
                    ...
                    <asp:DropDownList ID="AssetAccountDropDownList" runat="server" CssClass="select-chosen"  data-live-search="true" 
                        AppendDataBoundItems="True" DataTextField="accountname" DataValueField="accountid" DataSourceID="AccountDS">
                            <asp:ListItem Text="<%$ Resources:DefaultResource, SelectItemPlease%>" Value="0" />
                    </asp:DropDownList>
            ...
            <label class="col-2 col-form-label">
                ...
                <div class="col-4">
                    ...
                    <asp:DropDownList ID="DiscountAccountDropDownList" runat="server" CssClass="select-chosen"  data-live-search="true" 
                        AppendDataBoundItems="True" DataTextField="accountname" DataValueField="accountid" DataSourceID="AccountDS">
                            <asp:ListItem Text="<%$ Resources:DefaultResource, SelectItemPlease%>" Value="0" />
                    </asp:DropDownList>
         ...
         <div class="form-group row">
                ...
                <div class="col-4">
                    ...
                    <asp:DropDownList ID="PaymentAccountDropDownList" runat="server" CssClass="select-chosen"  data-live-search="true" 
                        AppendDataBoundItems="True" DataTextField="accountname" DataValueField="accountid" DataSourceID="AccountDS">
                            <asp:ListItem Text="<%$ Resources:DefaultResource, SelectItemPlease%>" Value="0" />
                    </asp:DropDownList>
            ...
            <label class="col-2 col-form-label">
                ...
                <div class="col-4">
                    ...
                    <asp:DropDownList ID="ProfitAccountDropDownList" runat="server" CssClass="select-chosen"  data-live-search="true" 
                        AppendDataBoundItems="True" DataTextField="accountname" DataValueField="accountid" DataSourceID="AccountDS">
                            <asp:ListItem Text="<%$ Resources:DefaultResource, SelectItemPlease%>" Value="0" />
                    </asp:DropDownList>
