<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Widgets_Row.ascx.cs" Inherits="WebSchool.Controls.ContentPages.Widgets_Row" %>
                                            ...
                                            <ul class="timeline-list">
                                                    ...
                                                    <div class="timeline-content">
                                                        ...
                                                        <div class="row push">
                                                            <div class="col-sm-6 col-md-4">
                                                                <a href="../assets/img/placeholders/photos/photo1.jpg" data-toggle="lightbox-image">
                                                                    <img src="../assets/img/placeholders/photos/photo1.jpg" alt="image">
                                                                </a>
                                                            </div>
                                                            <div class="col-sm-6 col-md-4">
                                                                <a href="../assets/img/placeholders/photos/photo22.jpg" data-toggle="lightbox-image">
                                                ...
                                                <li class="active">
                                                    ...
                                                    <div class="timeline-content">
                                                        ...
                                                        <div class="row push">
                                                            <div class="col-sm-6 col-md-4">
                                                                <a href="../assets/img/placeholders/photos/photo23.jpg" data-toggle="lightbox-image">
                                                                    <img src="../assets/img/placeholders/photos/photo23.jpg" alt="image">
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="widget">
                                    <div class="widget-advanced widget-advanced-alt">
                                        ...
                                        <div class="widget-header text-left">
                                            ...
                                            <img src="../assets/img/placeholders/headers/widget5_header.jpg" alt="background" class="widget-background animation-pulseSlow">
