<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TeacherLeftSideBarNew.ascx.cs" Inherits="WebSchool.controls.CommonTeacher.TeacherLeftSideBarNew" %>
    <!-- Alternative Sidebar -->
                <div id="sidebar-alt">
                    ...
                    <div id="sidebar-scroll">
                        ...
                        <div class="sidebar-content">
                            ...
                            <ul class="sidebar-nav">
                                <li>
                                    ...
                                    <a href="#" class="sidebar-nav-menu">
                                        ...
                                        <%= Resources.DefaultResource.TeachersAffairs%>
                                      </span></a>
                                    <ul>
                                        <li>
                                            <a href="../../Admin/SchStudents.aspx"><%=Resources.DefaultResource.TeacherData%></a>
                                        </li>
                                    ...
                                    <a href="#" class="sidebar-nav-menu">
                                        ...
                                        <%= Resources.DefaultResource.ClassesData%>
                                      </span></a>
                                    <ul>
                                        <li>
                                            <a href="../../Admin/SchTeachersWorkOrders.aspx"><%=Resources.DefaultResource.TeacherClass%></a>
                                        </li>
                         ...
                         <li>
                                    ...
                                    <ul>
                                        <%--<li>
                                            <a href=""><%=Resources.DefaultResource.SchoolSalesReport%></a>
                                        </li>
                                        
                                        <li>
                                            <a href="../../Admin/SchWorkOrderRpt.aspx"><%=Resources.DefaultResource.SchoolWorkordersReport%></a>
                                        </li>
                                         <li>
