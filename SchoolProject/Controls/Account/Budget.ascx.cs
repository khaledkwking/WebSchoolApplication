        ...
        protected void PrintBtn_Click(object sender, EventArgs e)
        {
            ...
            string AccountName = "";
                ...
                if (StartDateTextBox.Text != "" && EndDateTextBox.Text !="")
                {
                    ...
                    string Url = "QidShowRpt.aspx?Id=13&SDate=" + curDate.ToString("dd/MM/yyyy") + "&EDate=" + curDate1.ToString("dd/MM/yyyy") + "&BranchId=" + BranchId.ToString() + "&CostId=" + CostId.ToString() + "&AcounntId=" + AcounntId.ToString();
