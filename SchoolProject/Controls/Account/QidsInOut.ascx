<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="QidsInOut.ascx.cs" Inherits="WebSchool.Controls.Account.QidsInOut" %>
    ...
    <div class="kt-portlet__head kt-portlet__head--lg">
        <div class="kt-portlet__head-label">
            ...
            <h3 class="kt-portlet__head-title">
                <%= Request.QueryString["TypeId"].ToString() == GLibrary.strarrQidTypes[0, 0].ToString() ? Resources.DefaultResource.AccountQids :""  %><%= Request.QueryString["TypeId"].ToString() == GLibrary.strarrQidTypes[6, 0].ToString()  ? Resources.DefaultResource.AccountInQid :""  %><%= Request.QueryString["TypeId"].ToString() == GLibrary.strarrQidTypes[5, 0].ToString()  ? Resources.DefaultResource.AccountOutQid :""  %><%--  <asp:Literal runat="server" Text="<%$ Resources:DefaultResource, AccountQids%>" />--%>
            </h3>
        </div>
            ...
            <div class="kt-portlet__head-wrapper">
                <div class="kt-portlet__head-actions">
                    ...
                    <asp:LinkButton ID="NewRecord" runat="server" CssClass="btn btn-brand btn-elevate btn-icon-sm"  data-bs-toggle="tooltip"
                        title="<%$ Resources:DefaultResource, AddNewQid%>" data-original-title="<%$ Resources:DefaultResource, AddNewQid%>" OnClick="NewRecord_Click">
                        <i class="la la-plus"></i>
                        <asp:Literal runat="server" Text="<%$ Resources:DefaultResource, AddNewQid%>" />

                    </asp:LinkButton>


                </div></div></div></div><div class="kt-portlet__body">
...
<div class="form-group row">
    ...
    <div  class="table-responsive col-12">
                   ...
                   <%-- <td>
                        ...
                        <td class="text-center block-options">
                           <asp:LinkButton ID="EditLinkButton" runat="server" CommandName="Edit"  data-bs-toggle="kt-tooltip"
                            ...
                            </asp:LinkButton><asp:HyperLink ID="LinkButtonprint" runat="server" CommandName="Print"  data-bs-toggle="kt-tooltip" Text ="<%$ Resources:DefaultResource, Print%>" title="<%$ Resources:DefaultResource, Print%>"
                                CssClass="btn btn-outline-info btn-icon-sm" CommandArgument='<%# Eval("qidid") %>' data-original-title="<%$ Resources:DefaultResource, Print%>" NavigateUrl='<%# String.Format("../../Admin/QidShowRpt.aspx?Id={0}&QidId={1}",Eval("recitetype"),Eval("qidid")) %>' Target="_blank" >
                                ...
                                <div class="modal-content">
                                      <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="basicModalLabel">
                                                  <%= Request.QueryString["TypeId"].ToString() == GLibrary.strarrQidTypes[6, 0].ToString()  ? Resources.DefaultResource.QidInDetailsTitle :""  %>
                                            <%= Request.QueryString["TypeId"].ToString() == GLibrary.strarrQidTypes[5, 0].ToString()  ? Resources.DefaultResource.QidOutDetailsTitle :""  %>
                                                 <%-- <div class="col-10">
                                            <span class="kt-switch kt-switch--lg kt-switch--icon">
                                                <label>
                                                    <asp:CheckBox ID="AllowDisplayCheckBox" runat="server" Checked='<%# Bind("ActiveFlag") %>' />
                                        ...
                                        </div>--%><%--  <label for="qididlabel" class="col-2 col-form-label">
                                            <asp:Literal ID="Literal1" runat="server" Text="<%$ Resources:DefaultResource, QidAutoNo%>" />
                                        </label>--%></h4>
                               ...
                               <%-- <div class="block-title">
                                ...
                                <div class="kt-portlet__body">
                                       ...
                                       <div class="col-4">
                                            ...
                                            </asp:RequiredFieldValidator></div><label class="col-2 control-label"><asp:Literal ID="Literal8" runat="server" Text="<%$ Resources:DefaultResource, Date%>" />
                                        ...
                                        <div class="col-4">
                                            ...
                                            </asp:RequiredFieldValidator></div><label class="col-2 control-label"><asp:Literal ID="Literal4" runat="server" Text="<%$ Resources:DefaultResource, EmpNo%>" />
                                                                               </label>
                                                <div class="col-4">
                                    ...
                                    <%-- style="display: <%= Request.QueryString["TypeId"].ToString() !=  GLibrary.strarrQidTypes[0, 0].ToString() ? "normal":"none"  %>"--%>
                                      <div class="form-group row" >
                                          <label class="col-2 control-label">
                                              <%-- <asp:Literal ID="Literal5" runat="server" Text="<%$ Resources:DefaultResource, PaymentType%>" />--%>
                                        ...
                                        <div class="col-4">
                                            ...
                                            <asp:DropDownList ID="DropDownListPaymentType" runat="server" CssClass="form-control" data-live-search="true"
                                                AppendDataBoundItems="True" AutoPostBack="True" OnSelectedIndexChanged="DropDownListPaymentType_SelectedIndexChanged">
                                                <asp:ListItem  Value="1" text="<%$ Resources:DefaultResource, Cash%>"> 
                                                   ...
                                                   </asp:ListItem></asp:DropDownList></div><label class="col-2 control-label"><asp:Literal ID="lblBank" runat="server" Text="<%$ Resources:DefaultResource, BankAccount%>" />
                                          </label>
                                        <div class="col-4">

                                            <asp:DropDownList ID="DropDownListBankOrBox" runat="server" CssClass="form-control selectpicker" data-live-search="true" DataTextField="accountname" DataValueField="accountid" DataSourceID="AccountDSBankOrBox">
                                                <%--<asp:ListItem Text="<%$ Resources:DefaultResource, SelectItemPlease%>" Value="0" />--%>
                                            </asp:DropDownList>

                                             <asp:RequiredFieldValidator ID="RequiredFieldValidatorBank" runat="server" ErrorMessage="<%$ Resources:DefaultResource, RequiredField%>" Display="Dynamic"
                                                ControlToValidate="DropDownListBankOrBox"  InitialValue="0"  ValidationGroup="DML" CssClass="label label-warning" SetFocusOnError="true">
                                            </asp:RequiredFieldValidator></div></div><%--  style="display: <%= Request.QueryString["TypeId"].ToString() !=  GLibrary.strarrQidTypes[5, 0].ToString() ? "normal":"none"  %>"--%>
                                    <div class="form-group row">
                                       
                                        
                                          <label class="col-2 control-label">
                                              <asp:Literal ID="Literal10" runat="server" Text="<%$ Resources:DefaultResource, ReceivedName%>" />
                                                                               </label>
                                                <div class="col-4">
                                           
                                            <asp:TextBox ID="TextBox1" runat="server"  CssClass="form-control" placeholder="<%$ Resources:DefaultResource, ReceivedName%>" /></div>
                                                <label class="col-2 control-label">
                                                <asp:Literal ID="lblChequeNo" runat="server" Text="<%$ Resources:DefaultResource, ChequeNo%>" />
                                                                               </label>
                                                <div class="col-4">
                                           
                                            <asp:TextBox ID="ChequeNoTextBox" runat="server"  CssClass="form-control" placeholder="<%$ Resources:DefaultResource, ChequeNo%>" /></div>
                                     ...
                                     <div class="form-group row">
                                         ...
                                         &nbsp <asp:Button ID="CancelButton" runat="server"  Text="<%$ Resources:DefaultResource, Cancel%>" CssClass="btn btn-warning "   data-bs-toggle="modal" />
                                          &nbsp <%--  <i class="la la-angle-down"></i>--%><asp:LinkButton ID="LinkButtonprint" runat="server" CommandName="Print"  data-bs-toggle="kt-tooltip" Text ="<%$ Resources:DefaultResource, Print%>" title="<%$ Resources:DefaultResource, Print%>"
                                CssClass="btn btn-outline-info btn-icon-sm" CommandArgument='<%# Eval("qidid") %>' data-original-title="<%$ Resources:DefaultResource, Print%>" PostBackUrl='<%# String.Format("../../Admin/QidShowRpt.aspx?Id={0}&QidId={1}",Eval("recitetype"),Eval("qidid")) %>' >
                                <i class="fa fa-print"></i>
                            </asp:LinkButton><%-- <asp:LinkButton ID="LinkButtonConfirm" runat="server" CommandName="Confirm"  data-bs-toggle="kt-tooltip"  PostBackUrl='<%# String.Format("../../QidShowRpt.aspx?QidId={0}",Eval("qidid")) %>'
                            title="<%$ Resources:DefaultResource, Print%>" CssClass="btn btn-info"
                            data-original-title="<%$ Resources:DefaultResource, Print%>">
                                <i class="fa fa-print"></i>        
                        </asp:LinkButton>--%></div>
     ...
     <div class="row">
         <asp:ListView ID="ListViewQid" runat="server" DataKeyNames="QidID"  OnItemCommand="ListViewQid_ItemCommand" OnItemDataBound="ListViewQid_ItemDataBound" AutoGenerateColumns="false" OnDataBound="ListViewQid_DataBound" OnLayoutCreated="ListViewQid_LayoutCreated"><%--  <EmptyDataTemplate>  </EmptyDataTemplate>--%>
                <ItemTemplate>
                      <tr style="">
               ...
               <asp:TextBox ID="txtqidid" CssClass="form-control" runat="server" Text='<%# Eval("qidid") %>' Visible="false" />
                ...
                <asp:TextBox ID="txtInvId" CssClass="form-control" runat="server"  Visible="false"  Text='<%# Eval("InvId") %>' />
                  <td style="display: <%# Request.QueryString["TypeId"].ToString() == GLibrary.strarrQidTypes[6, 0].ToString() ? "normal":"none" %>">
                     <asp:TextBox ID="txtFromValue" CssClass="form-control" runat="server" Text='<%# Eval("FromValue","{0:N3}") %>' TextMode="Number" /> </td>
                   
                   <td style="display: <%# Request.QueryString["TypeId"].ToString() == GLibrary.strarrQidTypes[5, 0].ToString() ? "normal":"none" %>">
                    ...
                    <td>
                        <asp:DropDownList ID="ddlACCOUNTID" runat="server" DataSourceID="AccountDS"  AppendDataBoundItems="true" CssClass="select-chosen"    DataTextField="accountname"
                            DataValueField="AccountId"  Text='<%# Bind("ACCOUNTID") %>' AutoPostBack="False" CausesValidation="False">     
                ...
                <table class="table table-striped table-bordered table-hover table-checkable">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th id="ThFormvalue" style="width: 15%" runat="server"  > 
                              
                                <asp:LinkButton ID="FromValueTitleLinkButton" runat="server" CommandArgument="Credit" CommandName="Sort" Text="<%$ Resources:DefaultResource, ValueTitle %>" /></th>
                          <%--  قبض  --%>
                            <th style="width: 15%" runat="server"  id="ThTovalue">
                                <asp:LinkButton ID="ToValueLinkButton" runat="server" CommandArgument="Debit" CommandName="Sort" Text="<%$ Resources:DefaultResource, ValueTitle %>" /></th>
                            <th style="width: 30%">
 ...
 <div class="row">
     <label class="col-2 control-label">
           <asp:Literal ID="Literal5" runat="server" Text="<%$ Resources:DefaultResource, Total%>" />

         </label>
                                         <div class="col-6">
                                             <asp:Label ID="Total" runat="server" Text="" CssClass="text-primary font-weight-bold"></asp:Label></div>
 

                                    </div>
                                
                            </div><asp:ObjectDataSource ID="QidsDS" runat="server"  SelectMethod="Read" TypeName="BOL.Qids" DeleteMethod="DML" InsertMethod="DML" UpdateMethod="DML"><DeleteParameters><asp:Parameter Name="ActionCode" Type="String" DefaultValue="3" /><asp:Parameter Name="qidid" Type="Int64" /><asp:Parameter Name="qidcode" Type="String" /><asp:Parameter Name="qidDate" Type="String" /><asp:Parameter Name="Notes" Type="String" /><asp:Parameter Name="recitetype" Type="Int32" /><asp:Parameter Name="BranchId" Type="Int64" /><asp:Parameter Name="OrgId" Type="Int64" /><asp:Parameter Name="EmpId" Type="Int64" /><asp:Parameter Name="repeated" Type="Boolean" /><asp:Parameter Name="BankAccId" Type="Int64" /><asp:Parameter Name="ChequeNo" Type="String" /><asp:Parameter Name="InvId" Type="Int64" /><asp:Parameter Name="ReorderInvId" Type="Int64" /><asp:Parameter Name="PaymentType" Type="Int32" /><asp:Parameter Name="PaymentTo" Type="String" /><asp:Parameter Name="CreatedBy" Type="Int32" /><asp:SessionParameter Name="UpdateBy" SessionField="UserId" Type="Int32" /><asp:SessionParameter DefaultValue="" Name="DeletedBy" SessionField="UserId" Type="Int32" /><asp:Parameter Name="TotalDesc" Type="String" /><asp:Parameter Direction="InputOutput" Name="OutId" Type="Object" /></DeleteParameters>
            <InsertParameters>
    ...
    <asp:TextBox ID="txtFromValue" runat="server" 
        ...
        Visible="False" meta:resourcekey="txtUserIdResource1" Height="22px"></asp:TextBox><asp:TextBox ID="txtBoxAccountId" runat="server" 
        Visible="False" meta:resourcekey="txtUserIdResource1" Height="22px"></asp:TextBox></div></div>
                                </div>

            </div>
                                <asp:ObjectDataSource ID="AccountDS" runat="server"  SelectMethod="Read" TypeName="BOL.Accounts" OldValuesParameterFormatString="original_{0}"><SelectParameters><asp:Parameter DefaultValue="3" Name="ActionCode" Type="String" /><asp:Parameter Name="AccountId" Type="Int64" /><asp:SessionParameter Name="OrgId" SessionField="OrgId" Type="Int64" /><asp:Parameter Name="BRANCHId" Type="Int64" /><asp:Parameter Name="ParentAccountId" Type="Int64" /><asp:Parameter Name="CostId" Type="Int64" /><asp:Parameter Name="StartDate" Type="String" /><asp:Parameter Name="EndDate" Type="String" /><asp:Parameter Name="SearchText" Type="String" /><asp:Parameter Name="AccountCode" Type="String" /><asp:Parameter Name="AccountName" Type="String" /></SelectParameters></asp:ObjectDataSource>

    

    <asp:ObjectDataSource ID="AccountDSBankOrBox" runat="server"  SelectMethod="Read" TypeName="BOL.Accounts" OldValuesParameterFormatString="original_{0}"><SelectParameters><asp:Parameter DefaultValue="3" Name="ActionCode" Type="String" /><asp:Parameter Name="AccountId" Type="Int64" /><asp:SessionParameter Name="OrgId" SessionField="OrgId" Type="Int64" /><asp:Parameter Name="BRANCHId" Type="Int64" /><asp:ControlParameter ControlID="txtBoxAccountId" DefaultValue="" Name="ParentAccountId" PropertyName="Text" Type="Int64" /><asp:Parameter Name="CostId" Type="Int64" /><asp:Parameter Name="StartDate" Type="String" /><asp:Parameter Name="EndDate" Type="String" /><asp:Parameter Name="SearchText" Type="String" /><asp:Parameter Name="AccountCode" Type="String" /><asp:Parameter Name="AccountName" Type="String" /></SelectParameters></asp:ObjectDataSource>
