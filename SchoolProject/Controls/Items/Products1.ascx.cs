...
{
    public partial class Products1 : System.Web.UI.UserControl
    {
        ...
        public void GetNodeInfo()
        {
            ...
            if (ProductNameTextBox.Text != "" & ProductCodeTextBox.Text != "")
            {
                ...
                if (!EditFlag)
                {
                     v = (DataView)GEODSByCode.Select();
                    if (v.Count > 0)
                    {

                        ErrorDiv.InnerHtml = "<div class=\"alert alert-success\" role=\"alert\">" + Resources.DefaultResource.DuplicateItemCodeMsg.ToString() + "</div>";
                        SaveFlag = false;
        ...
        {
            //this.HomeTab.Attributes["class"] = "tab-pane active";
            this.PriceTab.Attributes["class"] = "tab-pane ";
            //home.Attributes["class"] = "tab-pane fade show active";
            profile.Attributes["class"] = "tab-pane fade";

            HiddenFieldTab1.Value = "tab-pane fade show active";
        ...
        private void SetTab2()
        {
            ...
            profile.Attributes["class"] = "tab-pane fade show active";
