...
public partial class Admin_PerQlfList : System.Web.UI.Page
{
    ...
    private void GetData()
    {
        ...
        DataView v = (DataView)ObjectDataSourcePerQlfParam.Select();
        if (v.Count > 0)
        {
            txtQlfCode.Text = v.Table.Rows[0]["QLF_CODE"].ToString();
            txtQlfName.Text = v.Table.Rows[0]["QLF_DESC"].ToString();
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
      //
        ...
        if ((e.CommandName == "Update"))
        {
            ...
            this.Response.Redirect("PerQlfList.aspx?Id=" + Id);
    ...
    protected void cmdsave_Click(object sender, EventArgs e)
    {
        try
        {
           ...
           if (txtEditFlag.Text == "1")
           {
            ...
            {
                 ObjectDataSourcePerQlf.Insert();
                ObjectDataSourcePerQlf.DataBind();
