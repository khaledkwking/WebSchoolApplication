...
public partial class Admin_DeptList : System.Web.UI.Page
{
    ...
    private void GetData()
    {
        ...
        DataView v = (DataView)ObjectDataSourceDeptParam.Select();
        if (v.Count > 0)
        {
            txtDeptCode.Text = v.Table.Rows[0]["DEPT_CODE"].ToString();
            txtDeptName.Text = v.Table.Rows[0]["DEPT_DESC"].ToString();
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
      //
        ...
        if ((e.CommandName == "Update"))
        {
            ...
            this.Response.Redirect("DeptList.aspx?Id=" + Id);
