<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMainPageMaster.Master" AutoEventWireup="true" Inherits="Admin_QidInOutList" Codebehind="QidInOutList.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentContentPlaceHolder" Runat="Server">
     ...
     <WEB:QidsInOut ID="QidsInOutUC" runat="server" />
