<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMainPageMaster.Master" AutoEventWireup="true" Inherits="Admin_StatementSheet" Codebehind="StatementSheet.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentContentPlaceHolder" Runat="Server">
     ...
     <WEB:StatementSheet ID="StatementSheetUC" runat="server" />
