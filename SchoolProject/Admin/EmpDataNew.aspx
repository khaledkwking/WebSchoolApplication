<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPageMain.master" AutoEventWireup="true" Inherits="Admin_EmpDataNew" EnableViewStateMac="false" EnableEventValidation="false"  ValidateRequest="false" Codebehind="EmpDataNew.aspx.cs" %>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="formContactUs">
                        ...
                        <div class="form-group row" >
                             <div class="col-sm-11 txtAlign" >
                                    <asp:Label ID="Label3" runat="server"   Text="الرقم الالى" Font-Bold="True"></asp:Label>
                                    </div>            
                                <div class="col-sm-11" >
                                  <asp:Label ID="lblAppNo" runat="server" Font-Bold="True"  ForeColor="Red"> </asp:Label>
                            </div>
                        </div>
                   <div class="form-group row" >
                             <div class="col-sm-9 txtAlign" >
                                    <asp:Label ID="Label6" runat="server" Text="رقم الموظف" Font-Bold="True"></asp:Label>
                                    </div>
              
                                <div class="col-sm-9" >
                                     <asp:TextBox ID="txtEmpCode" runat="server" class="form-control" placeholder="رقم الموظف"></asp:TextBox>
                         ...
                         <div class="form-group row" >
                             <div class="col-sm-9 txtAlign" >                      
                                <asp:Label ID="Label1" runat="server"  Font-Bold="True" Text="الرقم المدني" ></asp:Label>
                                    </div>
                                <div class="col-sm-9" >
                                    <asp:TextBox ID="txtCivilId" runat="server" CssClass="form-control"  required="required" placeholder="الرقم المدنى"></asp:TextBox>
                                     <span class="alert-text" >*</span>
                             ...
                             <div class="col-sm-9 txtAlign">
                                 ...
                                 <asp:Label ID="Label47" runat="server"  Font-Bold="True"   Text="الجنس" ></asp:Label>
                                    </div>
                                <div class="col-sm-9" >
                                      <asp:DropDownList ID="CmbEmpGender" runat="server" CssClass="form-control"  Font-Bold="True" required="required" DataSourceID="ObjectDataSourceSex" DataTextField="Sex" DataValueField="Id" placeholder="الجنس">
                                    </asp:DropDownList>
                                     <span class="alert-text" >*</span>
                              ...
                              <div class="form-group row" >
                             <div class="col-sm-9 txtAlign">
                                 <asp:Label ID="Label4" runat="server"  Font-Bold="True" Text="الديانة" ></asp:Label>
                                    </div>
                                <div class="col-sm-9" >

                                       <asp:DropDownList ID="cmbRelgion" runat="server" CssClass="form-control" Font-Bold="True"  DataSourceID="ObjectDataSourceRelgion" DataTextField="ReligionDesc" DataValueField="ReligionId" placeholder="الديانة" required="required">
                                       </asp:DropDownList>
                                   <span class="alert-text" >*</span>
                        ...
                        <div class="form-group row" >
                             <div class="col-sm-9 txtAlign" >
                                    <asp:Label ID="Label7" runat="server" Text="الاسم الاول" Font-Bold="True"></asp:Label>
                             </div>
                           <div class="col-sm-9" >
                                    <asp:TextBox ID="txtEmpName1" runat="server" class="form-control" placeholder="الاسم الاول"></asp:TextBox> 
                                     <span class="alert-text" >*</span>
                            </div>
                            </div>
                           ...
                           <div class="form-group row" >
                                <div class="col-sm-9 txtAlign" >
                                    <asp:Label ID="Label8" runat="server" Text="الاسم الثانى" Font-Bold="True"></asp:Label>
                             </div>
                          <div class="col-sm-9" >
                                       <asp:TextBox ID="txtEmpName2" runat="server" CssClass="form-control" placeholder="الاسم الثانى" ></asp:TextBox>
                                     <span class="alert-text" >*</span>
                            </div>
                               </div>
                           <div class="form-group row" >
                                <div class="col-sm-9 txtAlign" >
                                    <asp:Label ID="Label9" runat="server" Text="الاسم الثالث" Font-Bold="True"></asp:Label>
                             </div>
                            <div class="col-sm-9" >
                                           <asp:TextBox ID="txtEmpName3" runat="server" CssClass="form-control" placeholder="الاسم الثالث" ></asp:TextBox>
                                     <span class="alert-text" >*</span>
                            </div>
                               </div>
                           <div class="form-group row" >
                                <div class="col-sm-9 txtAlign" >
                                    <asp:Label ID="Label10" runat="server" Text="الاسم الرابع" Font-Bold="True"></asp:Label>
                             </div>
                           <div class="col-sm-9" >
                                  <asp:TextBox ID="txtEmpName4" runat="server" CssClass="form-control"  placeholder="الاسم الرابع" ></asp:TextBox>
                                     <span class="alert-text" >*</span>
                            </div>
                               </div>
                           <div class="form-group row" >
                                <div class="col-sm-9 txtAlign" >
                                    <asp:Label ID="Label12" runat="server" Text="الاسم الخامس" Font-Bold="True"></asp:Label>
                             </div>
                           <div class="col-sm-9" >
                                <asp:TextBox ID="txtEmpName5" runat="server" CssClass="form-control"  placeholder="الاسم الخامس" ></asp:TextBox>
                                 <span class="alert-text" >*</span>
                            </div>
                               </div>
                         ...
                         <div class="form-group row" >
                                <div class="col-sm-9 txtAlign" >
                                    <asp:Label ID="Label42" runat="server"  Font-Bold="True"   Text="الاسم  الاول"></asp:Label>
                             </div>
                           <div class="col-sm-9" >
                                 <asp:TextBox ID="txtNameEng1" runat="server"  CssClass="form-control"  placeholder="الاسم الاول"  ></asp:TextBox>
                                 <span class="alert-text" >*</span>
                            </div>
                            </div>
                            <div class="form-group row" >
                                <div class="col-sm-9 txtAlign" >
                                    <asp:Label ID="Label13" runat="server"  Font-Bold="True"  Text="الاسم  الثانى" ></asp:Label>
                             </div>
                           <div class="col-sm-9" >
                                 <asp:TextBox ID="txtNameEng2" runat="server" CssClass="form-control" placeholder="الاسم الثانى"></asp:TextBox> 
                                 <span class="alert-text" >*</span>
                            </div>
                            </div>
                             ...
                             <div class="form-group row" >
                                <div class="col-sm-9 txtAlign" >
                                    <asp:Label ID="Label14" runat="server"  Font-Bold="True"  Text="الاسم  الثالث" ></asp:Label>
                             </div>
                           <div class="col-sm-9" >
                                  <asp:TextBox ID="txtNameEng3" runat="server" CssClass="form-control" placeholder="الاسم الثالث" ></asp:TextBox> 
                                 <span class="alert-text" >*</span>
                            </div>
                            </div>
                             ...
                             <div class="form-group row" >
                                <div class="col-sm-9 txtAlign" >
                                    <asp:Label ID="Label15" runat="server"  Font-Bold="True"  Text="الاسم  الرابع" ></asp:Label>
                             </div>
                           <div class="col-sm-9" >
                                 <asp:TextBox ID="txtNameEng4" runat="server" CssClass="form-control" placeholder="الاسم  انجليزي الرابع"></asp:TextBox> 
                                 <span class="alert-text" >*</span>
                              ...
                              <div class="form-group row" >
                                <div class="col-sm-9 txtAlign" >
                                    <asp:Label ID="Label16" runat="server"  Font-Bold="True"  Text="الاسم  الخامس" ></asp:Label>
                             </div>
                           <div class="col-sm-9" >
                                 <asp:TextBox ID="txtNameEng5" runat="server" CssClass="form-control" placeholder="الاسم الخامس"></asp:TextBox> 
                                 <span class="alert-text" >*</span>
                            </div>
                            </div>
                              <div class="form-group row" >
                                <div class="col-sm-9 txtAlign" >
                                    <asp:Label ID="Label2" runat="server"  Font-Bold="True"   Text="الراتب الاساسى"  ></asp:Label>
                             </div>
                           <div class="col-sm-9" >
                                 <asp:TextBox ID="txtLicenceNo" runat="server" CssClass="form-control" placeholder="الراتب"  ></asp:TextBox>
                                 <span class="alert-text" >*</span>
                            </div>
                            </div>
                              <div class="form-group row" >
                                <div class="col-sm-9 txtAlign" >
                                    <asp:Label ID="Label41" runat="server"  Font-Bold="True" Text=" انتهاء الاقامة"></asp:Label>
                             </div>
                           <div class="col-sm-9" >
                                    <asp:TextBox ID="txtVisaEndDate" runat="server" CssClass="form-control"   required="required" data-toggle="datepicker" placeholder="أنتهاء الاقامة"></asp:TextBox>
                                 <span class="alert-text" >*</span>
                            </div>
                            </div>
                              ...
                              <div class="form-group row" >
                                <div class="col-sm-9 txtAlign" >
                                   <asp:Label ID="Label45" runat="server"  Font-Bold="True"     Text="المؤهل" ></asp:Label>
                             </div>
                           <div class="col-sm-9" >
                                    <asp:DropDownList ID="cmbEducation" runat="server" CssClass="form-control" Font-Bold="True"  DataSourceID="ObjectDataSourceEduction" DataTextField="QLF_DESC" DataValueField="QLF_TYP_CODE">
                                    </asp:DropDownList>
                                 <span class="alert-text" >*</span>
                            </div>
                            </div>
                             ...
                             <div class="form-group row" >
                                <div class="col-sm-9 txtAlign" >
                                    <asp:Label ID="Label5" runat="server"  Font-Bold="True" Text="تاريخ الميلاد" ></asp:Label>
                             </div>
                           <div class="col-sm-9" >
                                 <asp:TextBox ID="txtEmpBirthDate" runat="server" CssClass="form-control" required="required" data-toggle="datepicker"  placeholder="تاريخ الميلاد" ></asp:TextBox>
                                 <span class="alert-text" >*</span>
                            </div>
                            </div>
                             ...
                             <div class="form-group row" >
                                <div class="col-sm-9 txtAlign" >
                                    <asp:Label ID="Label44" runat="server" Font-Bold="True"  Text="الوظيفة بالانجليزية" ></asp:Label>
                             </div>
                           <div class="col-sm-9" >
                                <asp:DropDownList ID="CmbEngJob" runat="server" CssClass="form-control" Font-Bold="True"  DataSourceID="ObjectDataSourceJobs" DataTextField="JOB_CLS_DESC_Eng" DataValueField="JOB_CLS_CODE">
                                    </asp:DropDownList>
                            ...
                            <div class="form-group row" >
                                <div class="col-sm-9 txtAlign" >
                                  <asp:Label ID="Label43" runat="server"  Font-Bold="True"  Text="الوظيفة" ></asp:Label>
                             </div>
                           <div class="col-sm-9" >
                               <asp:DropDownList ID="CmbJob" runat="server" CssClass="form-control" Font-Bold="True"  DataSourceID="ObjectDataSourceJobs" DataTextField="JOB_CLS_DESC" DataValueField="JOB_CLS_CODE">
                                 </asp:DropDownList>
                             ...
                             <div class="form-group row" >
                                <div class="col-sm-9 txtAlign" >
                                 <asp:Label ID="Label11" runat="server"  Font-Bold="True" Text="مكان الميلاد"></asp:Label>
                             </div>
                           <div class="col-sm-9" >
                                <asp:TextBox ID="txtBirthPlace" runat="server" CssClass="form-control" placeholder="مكان الراتب"></asp:TextBox>
                             ...
                             <div class="form-group row" >
                                <div class="col-sm-9 txtAlign" >
                               <asp:Label ID="Label46" runat="server"  Font-Bold="True" Text="الجنسية" ></asp:Label>
                             </div>
                           <div class="col-sm-9" >
                                 <asp:DropDownList ID="CmbEmpNat" runat="server" CssClass="form-control" Font-Bold="True"  DataSourceID="ObjectDataSourceNats" DataTextField="NATIONALITY_DESC" DataValueField="NATIONALITY_CODE">
                                </asp:DropDownList>
                            </div>
                            </div>
                            ...
                            <div class="form-group row" >
                                <div class="col-sm-9 txtAlign" >
                              <asp:Label ID="Label49" runat="server"  Font-Bold="True"  Text="الحالة الاجتماعية" ></asp:Label>
                             </div>
                           <div class="col-sm-9" >
                                 <asp:DropDownList ID="CmbEmpMatStatus" runat="server" CssClass="form-control" Font-Bold="True"  DataSourceID="ObjectDataSourceMalStatus" DataTextField="StatusDesc" DataValueField="StatusId">
                                </asp:DropDownList>
                            </div>
                            </div>
                               ...
                               <div class="form-group row" >
                                <div class="col-sm-9 txtAlign" >
                             <asp:Label ID="Label50" runat="server"  Font-Bold="True" Text="رقم الاقامة" ></asp:Label>
                             </div>
                           <div class="col-sm-9" >
                                 <asp:TextBox ID="txtEmpVisaNo" runat="server" CssClass="form-control" placeholder="رقم الاقامة"></asp:TextBox>
                            </div>
                            </div>

                               <div class="form-group row" >
                                <div class="col-sm-9 txtAlign" >
                              <asp:Label ID="Label52" runat="server"  Font-Bold="True"  Text="نوع الاقامة"></asp:Label>
                             </div>
                           <div class="col-sm-9" >
                                   <asp:TextBox ID="txtVisatype" runat="server" CssClass="form-control"  placeholder="نوع الاقامة"></asp:TextBox>
                            </div>
                            </div>

                             <div class="form-group row" >
                                <div class="col-sm-9 txtAlign" >
                               <asp:Label ID="Label51" runat="server"  Font-Bold="True"  Text="الكفيل"></asp:Label>
                             </div>
                           <div class="col-sm-9" >
                                    <asp:DropDownList ID="CmbEmpBranch" runat="server" CssClass="form-control" Font-Bold="True"  DataSourceID="ObjectDataSourceBranches" DataTextField="BRANCHNAME" DataValueField="BRANCHCODE">
                                </asp:DropDownList>
                            </div>
                            </div>
                              ...
                              <div class="form-group row" >
                                <div class="col-sm-9 txtAlign" >
                               <asp:Label ID="Label53" runat="server"  Font-Bold="True"  Text="حالة الموظف" ></asp:Label>
              
                             </div>
                           <div class="col-sm-9" >
                                    <asp:DropDownList ID="CmbStatus" runat="server" Font-Bold="True" CssClass="form-control" DataSourceID="ObjectDataSourceEmpStatus" DataTextField="StatusDesc" DataValueField="Id">
                                    </asp:DropDownList>
                            </div>
                            </div>
                             ...
                             <div class="form-group row" >
                                <div class="col-sm-9 txtAlign" >
                              <asp:Label ID="Label54" runat="server" Font-Bold="True"    Text="الراتب" ></asp:Label>

                             </div>
                           <div class="col-sm-9" >
                                   <asp:TextBox ID="txtBSalary" runat="server" CssClass="form-control" placeholder="الراتب" ></asp:TextBox>
                            </div>
                            </div>

                            <div class="form-group row" >
                                <div class="col-sm-9 txtAlign" >
                             <asp:Label ID="Label55" runat="server"  Font-Bold="True"   Text="الراتب الفعلى" ></asp:Label>

                             </div>
                           <div class="col-sm-9" >
                                   <asp:TextBox ID="txtAcualSal" runat="server" CssClass="form-control" placeholder="الراتب الفعلى"></asp:TextBox>
                            </div>
                            </div>

                              <div class="form-group row" >
                                <div class="col-sm-9 txtAlign" >
                             <asp:Label ID="Label56" runat="server"  Font-Bold="True"  Text="اخر زيادة" ></asp:Label>

                             </div>
                           <div class="col-sm-9" >
                                   <asp:TextBox ID="txtLastInc" runat="server" CssClass="form-control" placeholder="اخر زيادة"></asp:TextBox>
