    <%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Sch_PayRecitesList.ascx.cs" Inherits="WebSchool.ADMIN.Controls.School.Sch_PayRecitesList" %>
...
<ul class="breadcrumb breadcrumb-top">
    ...
    <li> <a href="SchPaymentReciteAll.aspx?RFlag=1"> <%= Resources.DefaultResource.SchoolPayments %> </a></li>
</ul>
                                     ...
                                     <tbody>
                                            <tr style="">
                                                ...
                                                <td colspan="2">
                                                   ...
                                                   <%-- <%# Eval("InvPayment") %>--%>
                                                     <asp:label ID="Label6" runat="server"  class="control-label" Text='<%# Bind("InvPayment") %>'/>
                                                </td>
                                                <th> 
                                                     <label for="NotesTextBox" class="control-label">
                                                ...
                                                <td colspan="2">
                                                 ...
                                                 <th> 
                                                  ...
                                                  <td colspan="2">
                                                    <%--<%# Eval("InvRemain") %>--%>
                                                      <asp:label ID="LabelSalesMan" runat="server"  class="control-label" Text='<%# Bind("PervInfoNotes") %>'/>
                                                </td>
                       ...
                       <div class="col-md-12">
                            ...
                            <!--begin::Form-->
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:label ID="Label11" runat="server" CssClass="form-control" Text='<%# Bind("InvId") %>' Visible="false"/>
                                 ...
                                 <%--    <asp:TextBox ID="TextBoxOrgId" runat="server" CssClass="form-control" Text='<%# Bind("OrgId") %>'  Visible="false" />--%>
                                     ...
                                     <div class="form-group">
                                       ...
                                       <div class="col-sm-4 col-xs-4 col-4">
                                        ...
                                        <div class="col-sm-4 col-xs-4 col-4">
                                            <asp:DropDownList ID="DropDownListUser" Text='<%# Bind("UserId") %>'  runat="server" CssClass="form-control select-chosen" AppendDataBoundItems="True" DataSourceID="UsersDS" DataTextField="Name" DataValueField="ID"  >
                            ...
                            <th class ="text-center">
                             ...
                             <th class ="text-center">
                              ...
                              <th class ="text-center">
                               ...
                               <th class ="text-center">
                                <asp:LinkButton ID="LinkButton4" runat="server" CommandArgument="PaymentValue" CommandName="Sort" Text="<%$ Resources:DefaultResource, PayAmount%>" />
                            </th>
                            <th class ="text-center">
