<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Sch_InvoicesPaymentsDebtList.ascx.cs" Inherits="WebSchool.Admin.controls.School.Sch_InvoicesPaymentsDebtList" %>
...
<ul class="breadcrumb breadcrumb-top">
    ...
    <li> <%= Resources.DefaultResource.InvoicesDebts %> </li>
</ul>
...
<div class="block table-responsive">
    ...
    <div class="block-title">
        <h2><strong><%= Resources.DefaultResource.List%>  </strong> <%= Resources.DefaultResource.InvoicesDebts%> </h2>
            ...
            <div class="col-md-3">
             ...
             <div class="col-md-3">
                 ...
                 <div class="col-md-3">
                    ...
                    <asp:LinkButton ID="PrintLinkButton" runat="server" CssClass="btn btn-sm btn-info" OnClick="PrintLinkButton_Click" > <i class="fa fa-Print"></i>طباعة كشف المديونيات</asp:LinkButton>
        ...
        <asp:ListView ID="lv" runat="server" DataKeyNames="InvId" DataSourceID="InvoicesDS" OnItemCommand="lv_ItemCommand" OnItemDataBound="lv_ItemDataBound" >
            ...
            <ItemTemplate>
                <tr >
                    ...
                    <td>
                        <asp:Label ID="Label7" runat="server" Text='<%# Eval("StudentTel") %>' />
                    </td>
                      <td>
                   ...
                   <td class="text-center block-options">
                        ...
                        <%-- <a   data-toggle="tooltip" title="<%= Resources.DefaultResource.SchoolPayments%>"   class="btn btn-sm btn-warning" data-original-title="<%= Resources.DefaultResource.SchoolPayments%>" href="SchPaymentRecite.aspx?InvId=<%# Eval("InvId")%>">
                         ...
                         <a  data-toggle="tooltip" title="<%= Resources.DefaultResource.SchoolInvoiceReturns%>"   class="btn btn-sm btn-info" data-original-title="<%= Resources.DefaultResource.SchoolInvoiceReturns%>" href="SchPaymentReciteBack.aspx?InvId=<%# Eval("InvId")%>">
                            <i class="fa fa-eye"></i>
                        </a>  --%>
 ...
 <div class="modal-body table-responsive" id ="myBodaydiv">
    ...
    <asp:Parameter Name="OrgId" Type="Int64" /><asp:Parameter Name="BranchId" Type="Int64" /><asp:Parameter Name="CreatedBy" Type="Int32" /><asp:SessionParameter Name="UpdateBy" SessionField="UserId" Type="Int32" /><asp:SessionParameter DefaultValue="" Name="DeletedBy" SessionField="UserId" Type="Int32" />
            ...
            <SelectParameters><asp:Parameter Name="ActionCode" Type="String" DefaultValue="2" /><asp:ControlParameter ControlID="StartDateTextBox" Name="StartDate" PropertyName="Text" Type="String" /><asp:ControlParameter ControlID="EndDateTextBox" Name="EndDate" PropertyName="Text" Type="String" />
                ...
                <asp:Parameter Name="FinishFlag" Type="Int32" DefaultValue="2" />
