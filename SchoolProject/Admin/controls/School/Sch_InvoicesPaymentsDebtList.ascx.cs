...
namespace WebSchool.Admin.controls.School
{
    ...
    public partial class Sch_InvoicesPaymentsDebtList : System.Web.UI.UserControl
    {
            ...
            if (ViewState["Sch_InvDetails"] != null)
            {
                ...
                if (ddlSubjectId.Text != "")
                {
                    ...
                    if (TotalDebet == TotalNet) // || TotalDebet==0)
                    {
                        ...
                        {
                            dt.DML("2", InvId, InvCode, InvDate, StudentId, 0, PayTypeId, 0, InvType, 0, InvDate, Notes, Total, TotalNet, 0, 0, false, 0, StartInvDate, EndInvDate, 0, false, 0, StartInvDate, EndInvDate, 0, 0, 0, userId, "", SalesMan, InvSerial, false, 0, 0, false, false, false, false, QrgId, 0, USERID, USERID, USERID, ref CurInvId);
                            CurInvId = InvId;
                        }
                        else // Add new Invocie
                        {
                            dt.DML("1", InvId, InvCode, InvDate, StudentId, 0, PayTypeId, 0, InvType, 0, InvDate, Notes, Total, TotalNet, 0, 0, false, 0, StartInvDate, EndInvDate, 0, false, 0, StartInvDate, EndInvDate, 0, 0, 0, userId, "", SalesMan, InvSerial, false, 0, 0, false, false, false, false, QrgId, 0, USERID, USERID, USERID, ref CurInvId);
