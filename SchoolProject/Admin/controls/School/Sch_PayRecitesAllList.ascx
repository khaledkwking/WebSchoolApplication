    <%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Sch_PayRecitesAllList.ascx.cs" Inherits="WebSchool.ADMIN.Controls.School.Sch_PayRecitesAllList" %>
            ...
            <div class="block">
                ...
                <div class="form-horizontal form-bordered">
                        ...
                        <div class="col-sm-2 col-xs-2 col-2">
                            ...
                            <asp:Label ID="lblTotalKeynet" runat="server" Text="Label" CssClass="col-md-2 control-label" ForeColor="Red" Font-Bold="True"></asp:Label>
