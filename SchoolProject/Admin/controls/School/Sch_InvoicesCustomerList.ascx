<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Sch_InvoicesCustomerList.ascx.cs" Inherits="WebSchool.Admin.controls.School.Sch_InvoicesCustomerList" %>
...
<ul class="breadcrumb breadcrumb-top">
    ...
    <li> <%= Resources.DefaultResource.CustomerStatment %> </li>
</ul>
...
<div class="block table-responsive">
    ...
    <div class="block-title">
        <h2><strong><%= Resources.DefaultResource.List%>  </strong> <%= Resources.DefaultResource.CustomerStatment%> </h2>
    ...
    <div class="gallery gallery-widget" data-toggle="lightbox-gallery" style ="min-height:600px">
       ...
       <!-- General Data Block -->  
          <div class="input-group">
                <asp:Label ID="Label2" runat="server" Text='<%$ Resources:DefaultResource, PhoneNo%>' />
            <asp:TextBox ID="SearchTextBox" runat="server" CssClass="form-control" placeholder="<%$ Resources:DefaultResource, PhoneNo%>"></asp:TextBox>
       ...
       <div class="row">
             <div class="col-md-6">
                  <asp:LinkButton ID="PrintLinkButton" runat="server" CssClass="btn btn-sm btn-info" OnClick="PrintLinkButton_Click" > <i class="fa fa-Print"></i><%= Resources.DefaultResource.PrintCustomerStatment%></asp:LinkButton>
                  &nbsp; 
 ...
 <div class="modal-body table-responsive" id ="myBodaydiv">
    ...
    <asp:Parameter Name="OrgId" Type="Int64" /><asp:Parameter Name="BranchId" Type="Int64" /><asp:Parameter Name="CreatedBy" Type="Int32" /><asp:SessionParameter Name="UpdateBy" SessionField="UserId" Type="Int32" /><asp:SessionParameter DefaultValue="" Name="DeletedBy" SessionField="UserId" Type="Int32" />
            ...
            <SelectParameters><asp:Parameter Name="ActionCode" Type="String" DefaultValue="2" /><asp:ControlParameter ControlID="StartDateTextBox" Name="StartDate" PropertyName="Text" Type="String" /><asp:ControlParameter ControlID="EndDateTextBox" Name="EndDate" PropertyName="Text" Type="String" />
                ...
                <asp:Parameter DefaultValue="" Name="StudenId" Type="Int64" />
