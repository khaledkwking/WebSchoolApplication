...
{
    public partial class Sch_PayRecitesList : System.Web.UI.UserControl
    {
        ...
        protected void lv_PreRender(object sender, EventArgs e)
        {
            ...
            if (lv.InsertItem != null)
            {
                ...
                DropDownList dropDownList = (lv.InsertItem.FindControl("DropDownListUser") as DropDownList);

                if (dropDownList != null)
                {
                    if (Session["UserId"] != null)
                    {
                        dropDownList.SelectedValue = Session["UserId"].ToString();
                    }
