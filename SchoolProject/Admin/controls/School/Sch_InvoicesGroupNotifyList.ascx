<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Sch_InvoicesGroupNotifyList.ascx.cs" Inherits="WebSchool.Admin.controls.School.Sch_InvoicesGroupNotifyList" %>
...
<ul class="breadcrumb breadcrumb-top">
    ...
    <li> <%= Resources.DefaultResource.Notifcations %> </li>
</ul>
...
<div class="block table-responsive">
    ...
    <div class="block-title">
        <h2><strong><%= Resources.DefaultResource.List%>  </strong> <%= Resources.DefaultResource.Notifcations%> </h2>
            ...
            <ItemTemplate>
                <tr >
                    ...
                    <td >
                     ...
                     <td <%# Eval("InvType").ToString()=="1" ? "" :"style='display:none'"%> class ="text-center">
                        <asp:Label ID="Label4" runat="server" Text='<%# Eval("TotalInvHours") %>'  />
                    </td>
                      <td <%# Eval("InvType").ToString()=="1" ? "style='background-color:pink'" :"style='display:none'"%> class ="text-center">
                        <asp:Label ID="Label5" runat="server" Text='<%# Eval("TotalRemainHours") %>'  />
                    </td>
                ...
                <table id="general-table" class="table table-striped table-vcenter table-bordered table-condensed">
                    <thead >
                       ...
                       <th class ="text-center">
                            ...
                            <th <%# Eval("TotalInvHours").ToString()=="1" ? "" :"style='display:none'"%> class ="text-center">
                                <asp:LinkButton ID="LinkButton2" runat="server" CommandArgument="TotalInvHours" CommandName="Sort" Text="<%$ Resources:DefaultResource, SubjectHours%>" />
                            </th>    
                            <th <%# Eval("TotalInvHours").ToString()=="1" ? "" :"style='display:none'"%> class ="text-center">
                                <asp:LinkButton ID="LinkButton3" runat="server" CommandArgument="TotalRemainHours" CommandName="Sort" Text="<%$ Resources:DefaultResource, RemainHours%>" />
                            </th>    
                ...
                <table id="general-table" class="table table-bordered table-striped table-vcenter dataTable">
                 ...
                 <table class="table table-vcenter">
                    ...
                    <asp:Literal runat="server" Text="<%$ Resources:DefaultResource, TotalDebet%>" />
                            ...
                            <asp:ObjectDataSource ID="InvoicesDS" runat="server"  SelectMethod="Read" TypeName="BOL.Sch_LastInvoices" OldValuesParameterFormatString="original_{0}">
            <SelectParameters><asp:Parameter Name="ActionCode" Type="String" DefaultValue="2" />
                ...
                <asp:ControlParameter ControlID="FromDateTextBox" Name="StudyStartDate" PropertyName="Text" Type="String" DefaultValue="" /><asp:ControlParameter ControlID="EndDateTextBox" Name="StudyEndDate" PropertyName="Text" Type="String" />
