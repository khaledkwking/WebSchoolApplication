...
namespace WebSchool.Admin.controls.School
{
    ...
    public partial class Sch_InvoicesGroupNotifyList : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                if (Request.QueryString["Id"] != null)
                {
                    ...
                    {
                        InvoicesDS.SelectParameters["ActionCode"].DefaultValue = "2";
                        InvoicesDS.SelectParameters["InvType"].DefaultValue = Request.QueryString["Id"].ToString();
                        DropDownListGroupType.SelectedValue = Request.QueryString["Id"].ToString();
                        StartDateTextBox.Text = "";// DateTime.Today.ToShortDateString();
                        EndDateTextBox.Text = DateTime.Today.AddDays(3).ToShortDateString();
                    }
                    else if (Request.QueryString["Id"] == "1")
                    {
                        InvoicesDS.SelectParameters["ActionCode"].DefaultValue = "3";
                        InvoicesDS.SelectParameters["InvType"].DefaultValue = Request.QueryString["Id"].ToString();
                        DropDownListGroupType.SelectedValue = Request.QueryString["Id"].ToString();
                        StartDateTextBox.Text = "";// DateTime.Today.ToShortDateString();
                        EndDateTextBox.Text = "";
