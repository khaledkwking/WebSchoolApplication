<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Sch_StudentsIndvWorkOrdersList.ascx.cs" Inherits="WebSchool.ADMIN.Controls.School.Sch_StudentsIndvWorkOrdersList" %>
...
<div class="block">
    ...
    <div class="gallery gallery-widget" data-toggle="lightbox-gallery">
          ...
          <div class="row">
           <%-- <label for="PeriodDropDownList" class="col-md-2 control-label">
             ...
             <div class="col-md-4">
                        <asp:DropDownList ID="SubjectsDropDownList" runat="server" CssClass="form-control select-chosen" AppendDataBoundItems="True" DataSourceID="SubjectsDS" DataTextField="SubName" DataValueField="SubId" OnSelectedIndexChanged="SubjectsDropDownList_SelectedIndexChanged" AutoPostBack="True" >
      ...
      <div class="col-md-4">
                        <asp:DropDownList ID="DropDownListTeacher" runat="server" CssClass="form-control select-chosen" AppendDataBoundItems="True" DataSourceID="TeachersDS" DataTextField="Name" DataValueField="TeacherId">
    ...
    <div id="ErrorDiv" runat="server"></div>
        ...
        <asp:ObjectDataSource ID="StudentsIndvAttendanceDS" runat="server"  SelectMethod="Read" TypeName="BOL.Sch_StudentsIndvAttendance" DeleteMethod="DML" InsertMethod="DML" UpdateMethod="DML" OnInserted="StudentsIndvAttendanceDS_Inserted" OnInserting="StudentsIndvAttendanceDS_Inserting" OnUpdated="StudentsIndvAttendanceDS_Updated" OnUpdating="StudentsIndvAttendanceDS_Updating" OnDeleted="StudentsIndvAttendanceDS_Deleted" OldValuesParameterFormatString="original_{0}"><DeleteParameters><asp:Parameter Name="ActionCode" Type="String" DefaultValue="3" />
...
<asp:Parameter Name="DayTime" Type="String"></asp:Parameter>
            ...
            <SelectParameters>
                ...
                <asp:ControlParameter ControlID="EndDateTextBox" DefaultValue="" Name="EndDate" PropertyName="Text" Type="String" />
                <asp:Parameter Name="InvId" Type="Int64" DefaultValue="" />
                <asp:Parameter Name="InvDetId" Type="Int64" />
                <asp:ControlParameter ControlID="SubjectsDropDownList" Name="SubjectId" PropertyName="SelectedValue" Type="Int64" />
                <asp:ControlParameter ControlID="PeriodDropDownList" DefaultValue="" Name="PeriodId" PropertyName="SelectedValue" Type="Int64" />
                <asp:ControlParameter ControlID="DropDownListTeacher" DefaultValue="" Name="TeacherId" PropertyName="SelectedValue" Type="Int64" />
...
<asp:ObjectDataSource ID="TeachersDS" runat="server"  SelectMethod="Read" TypeName="BOL.Sch_Teachers"><SelectParameters>
        ...
        <asp:Parameter Name="TeacherId" Type="Int64" />
        <asp:Parameter DefaultValue="" Name="subjectId" Type="Int64" />
