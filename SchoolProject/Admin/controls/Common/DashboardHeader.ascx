<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DashboardHeader.ascx.cs" Inherits="WebSchool.ADMIN.Controls.Common.DashboardHeader" %>
                            ...
                            <div class="header-section">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-lg-6 hidden-xs hidden-sm">
                                        <h1><strong><%=Resources.DefaultResource.SystemName%></strong><br><small>You Look Awesome!</small></h1>
                                    </div>
                                    <!-- END Main Title -->
