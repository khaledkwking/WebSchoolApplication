<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMainPageMaster.Master" AutoEventWireup="true" Inherits="Admin_Setup" Codebehind="Setup.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentContentPlaceHolder" Runat="Server">
     ...
     <WEB:setup ID="setupUC" runat="server" />
