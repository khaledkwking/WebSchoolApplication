<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MainMaster.Master" AutoEventWireup="true" Inherits="Admin_QidShowRptOld" Codebehind="QidShowRptOld.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentContentPlaceHolder" Runat="Server">
     ...
     <WEB:QidShow ID="QidShowUC" runat="server" />
