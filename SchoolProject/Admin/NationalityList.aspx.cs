...
public partial class Admin_NationalityList : System.Web.UI.Page
{
    ...
    private void GetData()
    {
        ...
        DataView v = (DataView)ObjectDataSourceNatParam.Select();
        if (v.Count > 0)
        {
            txtDeptCode.Text = v.Table.Rows[0]["NATIONALITY_CODE"].ToString();
            txtNatName.Text = v.Table.Rows[0]["NATIONALITY_DESC"].ToString();
            txtNatEngName.Text = v.Table.Rows[0]["NATIONALITY_Eng"].ToString();
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
      //
        ...
        if ((e.CommandName == "Update"))
        {
            ...
            this.Response.Redirect("NationalityList.aspx?Id=" + Id);
    ...
    protected void cmdsave_Click(object sender, EventArgs e)
    {
        try
        {
           ...
           if (txtEditFlag.Text == "1")
           {
            ...
            {
                 ObjectDataSourceNat.Insert();
                ObjectDataSourceNat.DataBind();
