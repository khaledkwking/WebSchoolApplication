<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMainPageMaster.Master" AutoEventWireup="true" Inherits="Admin_IncomeList" Codebehind="IncomeList.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentContentPlaceHolder" Runat="Server">
     ...
     <WEB:IncomeStatement ID="IncomeStatementUC" runat="server" />
