        ...
        <div class="kt-grid kt-grid--hor kt-grid--root  kt-login kt-login--v6 kt-login--signin" id="kt_login">
            <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--desktop kt-grid--ver-desktop kt-grid--hor-tablet-and-mobile">
                                    ...
                                    <div class="kt-login__signin">
                                        ...
                                        <div class="">
                                            <div class="kt-form form-group">
                                                <web:SetupNewAccount ID="SetupNewAccountUC" runat="server" /> 
               ...
               <%-- <% if (Session["SiteLanguage"].ToString() == "EnglishTheme") { %>  
                <div class="kt-grid__item kt-grid__item--fluid kt-grid__item--center kt-grid kt-grid--ver kt-login__content" style="background: #dedede url(assets/media/bg/bg-Act6.png) center center no-repeat; background-size: contain;">
                    <div class="kt-login__section">
                    </div>
                </div>
               <% } else{ %> 
                <div class="kt-grid__item kt-grid__item--fluid kt-grid__item--center kt-grid kt-grid--ver kt-login__content" style="background: #dedede url(assets/media/bg/bg-Act6Ar.png) center center no-repeat; background-size: contain;">
                    <div class="kt-login__section">
                    </div>
                </div>
                <% };%> --%>
