...
namespace BOL
{
    ...
    public partial class Sch_Stages
    {
        ...
        /// </>
        #region "Read Section"
        public DAL.School.Sch_StagesDataTable  Read(string ActionCode,long StageId,long OrgId , long BranchId )
        {
            return StagesTableAdapter.Read(ActionCode, StageId, OrgId, BranchId);
        }
        #endregion
